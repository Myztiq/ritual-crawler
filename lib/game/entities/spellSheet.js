  ...
  .defines(function () {
    ...
    EntitySpellSheet = ig.Box2DEntity.extend({
      ...
      assignCombo: function (spell) {
        var buttons = [
          {direction: 'LEFT',   ps: 'sony/square-icon.png',    xbox: null},
          {direction: 'UP',     ps: 'sony/triangle-icon.png',  xbox: null},
          {direction: 'RIGHT',  ps: 'sony/circle-icon.png',    xbox: null},
          {direction: 'DOWN',   ps: 'sony/cross-icon.png',     xbox: null}
        ];
