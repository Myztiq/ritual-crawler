...
.defines(function () {
  EntityPlayer = ig.Box2DEntity.extend({
    ...
    update: function () {
      ...
      this.reticle.pos.x = this.pos.x + (this.size.x / 2) + reticleX;
      this.reticle.pos.y = this.pos.y + (this.size.y / 2) + reticleY;
    ...
    removeItemFromInventory(slotName, spawnItem) {
  ...
  EntityHead = ig.Box2DEntity.extend({
    ...
    animSheet: new ig.AnimationSheet('media/laser.png', 16, 16),
