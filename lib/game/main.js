...
MyGame = ig.Box2DGame.extend({
  ...
  init: function() {
    ...
    this.loadLevel( LevelTest2 );
		...
		Spells = [
			{name: 'Fire Ball', entity: EntityFireball, damageBase: 1, rangeBase: 10, type: 'offensive', level: 1, target: 'self', icon: 'fireball.png'},
			{name: 'spell', entity: EntitySpell, damageBase: 1, rangeBase: 10, type: 'offensive', level: 1, target: 'self', icon: 'fireball.png'},
			{name: 'laser', entity: EntityLaser, damageBase: 1, rangeBase: 10, type: 'offensive', level: 1, target: 'self', icon: 'fireball.png'},
		];
