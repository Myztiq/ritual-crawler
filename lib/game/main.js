...
MyGame = ig.Box2DGame.extend({
  ...
  init: function() {
    ...
    this.loadLevel( LevelTest );
		...
		Spells = [
			{name: 'Magic Missle', damageBase: 1, rangeBase: 10, type: 'offensive', level: 1, target: 'self'},
			{name: 'Shield', defenseBase: 1, rangeBase: 1, type: 'defensive', level: 1, target: 'other'}
		]
  },
