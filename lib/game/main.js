...
MyGame = ig.Box2DGame.extend({
  ...
  init: function() {
    ...
    ig.input.bind( ig.GAMEPAD1.PAD_LEFT, 'shoot_A_1');
    ig.input.bind( ig.GAMEPAD1.PAD_RIGHT, 'shoot_A_2');
    ig.input.bind( ig.GAMEPAD1.PAD_TOP, 'shoot_A_3');
    ig.input.bind( ig.GAMEPAD1.PAD_BOTTOM, 'shoot_A_4');
    ...
    ig.input.bind( ig.GAMEPAD2.PAD_LEFT, 'shoot_B_1');
    ig.input.bind( ig.GAMEPAD2.PAD_RIGHT, 'shoot_B_2');
    ig.input.bind( ig.GAMEPAD2.PAD_TOP, 'shoot_B_3');
    ig.input.bind( ig.GAMEPAD2.PAD_BOTTOM, 'shoot_B_4');
